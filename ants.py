...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        for i in range(0,self.lower_bound):
            if current_place:
                self.location+=1
        ...
        while not current_place.is_hive and self.location<=self.upper_bound and self.location>=self.lower_bound:
